...
// Fetch admin user session (to check if logged in)
...
// Fetch all articles posts from the store (logged in user)
...
// Fetch the selected posts from the store in CMS (logged in user)
...
// Fetch all stations from the store (logged in user)
...
// Fetch the selected station from the store in CMS (logged in user)
