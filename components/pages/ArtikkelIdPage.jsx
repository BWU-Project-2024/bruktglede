    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 font-opensans px-6 md:px-28 lg:px-64 pt-5 ">
                ...
                <div className="flex flex-col gap-3 mb-12 mt-5 md:max-w-[80%] lg:max-w-[70%]">
                    <h1 className="text-lg lg:text-xl font-semibold">{articleData.title}</h1>
                    <p className="text-lg lg:text-lg mb-2">{articleData.ingress}</p>
                    <p className="text-base">{articleData.bodyText}</p>
                </div>
                ...
                <div className="mt-6 mb-10">
                    <p className="text-xs lg:text-sm text-gray-600">Publisert : {formatDate(articleData.created_at)}</p>
                    <p className="text-xs lg:text-sm text-gray-600">Klokkeslett : {formatTime(articleData.created_at)}</p>
                </div>
            </main>
        </div>
    );
