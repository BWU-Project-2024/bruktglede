                    ...
                    <div className="flex justify-between h-full">
                        <div className='flex flex-col gap-1'>
                            <Link href={`/butikker/${store.id}`} key={index}>
                                <span className="text-lg font-medium underline hover:text-forestgreen-lighter transition transition-300">{store.name}</span>
                            </Link>
                    ...
                    <div className="flex justify-between">
                        <div className="flex flex-col gap-1 ">
                            <Link href={`/artikler/${post.id}`} key={index}>
                                <span className="text-lg font-medium underline hover:text-forestgreen-lighter transition transition-300">{post.title}</span>
                            </Link>
