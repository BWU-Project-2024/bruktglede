...
export const BliEndelCard = ({ tittel, tekst }) => {
  ...
  return (
    <>
      {!showForm && (
        <div className="bg-ivory-default w-full md:w-5/6 lg:w-9/12 h-72 lg:h-96 flex flex-col md:flex-row justify-center items-center md:gap-3 lg:gap-5 p-2 px-6 md:px-20 lg:px-20 mx-auto md:mb-10 lg:mb-30 lg:mt-20">
