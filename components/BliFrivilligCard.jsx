...
export const BliFrivilligCard = () => {
    return (
      <div className="bg-ivory-default w-full h-72 lg:h-96 flex flex-col lg:flex-row justify-center items-center md:gap-3 lg:gap-5 p-2 px-6 md:w-4/5 lg:w-3/4 max-w-readable md:px-20 lg:px-40 mx-auto md:mb-10 lg:mb-30 lg:mt-2  ">
